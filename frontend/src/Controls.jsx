      ...
      <div className="col-sm-12 col-md-8 offset-md-2">
        {!!user && (
          <>
            <div>
              ...
              <span id="watchedCount">
                {watchList?.filter((watched) => watched.watched).length || 0}
              </span>
              <span> / </span>
              <span>250</span>
            </div>
        ...
        <div className="mt-2">
          {genres?.map((genre) => (
            <button
              key={genre}
              className={classNames(`btn btn-outline-info ${styles.filter}`, {
                active: genreFilter.includes(genre),
              })}
