...
function Controls({genres, updateGenreFilter, genreFilter, setHideWatched, hideWatched, searchTerm, setSearchTerm}) {
        ...
        {!!user && <>
          ...
          <div className="mt-2">
            <button
              ...
              id="hide-watched"
              className={classNames("btn btn-outline-primary", {active: hideWatched})}>Hide Watched
            </button>
          </div>
        </>
        }
